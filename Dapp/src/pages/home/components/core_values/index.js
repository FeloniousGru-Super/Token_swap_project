        ...
        <div className="min-h-screen overflow-hidden bg-secondary-light relative">
            <div className="py-32 space-y-20 container mx-auto">
                ...
                <div className="flex gap-8">
                    <div className="bg-primary rounded-3xl px-4 pb-12 text-white text-center md:w-1/3">
                        ...
                        <p>The LunaChow team remains honest and forthright with the community always.</p>
                    </div>
